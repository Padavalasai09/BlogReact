    ...
    <div className='bg-gray-50 flex justify-center items-center h-screen'>
        ...
        <form >
            ...
            <div className="flex justify-between items-center">
                <button type="button" className="edit-btn bg-pink-600 text-white px-6 py-3 rounded-md w-full sm:w-auto hover:bg-pink-700 cursor-pointer font-bold" onClick={()=>{nav('/')}}>Cancel</button>
